...
TEST_CASE("Bad snowman code") {
	...
	CHECK_THROWS_AS(snowman(22222225),std::out_of_range); //5 is not in range
	...
	CHECK_THROWS_AS(snowman(01233341),std::out_of_range); // 0 not in range 
	CHECK_THROWS_AS(snowman(-11111111),std::out_of_range); // negative number 
